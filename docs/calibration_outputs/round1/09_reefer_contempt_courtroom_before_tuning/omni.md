# OMNI OUTPUT — 09_reefer_contempt_courtroom.wav

_Generated: 2026-07-30 16:13:42_
...
| Field | Value |
|-------|-------|
| File | 09_reefer_contempt_courtroom.wav |
| Duration | 00:29 (29.8s) |
| Whisper model | base |
| Language | en |
| Context | general |
...
|--------|------|------|-------------|-------|
| Lane | Person | [C:0.44] | 1 | heuristic ⚠️ verify |
| Mary | Person | [C:0.44] | 1 | heuristic ⚠️ verify |
| Involved | Person | [C:0.44] | 1 | heuristic ⚠️ verify |
| this community | Date (relative) | [C:0.88] | | |
...
| 00:05 | Speaker | 😐 | Neutral | 5/10 | 0.7s |  |  |
| 00:11 | Speaker | 🤩 | Elated | 8/10 | 1.3s |  |  |
| 00:19 | Speaker | 😐 | Neutral | 5/10 | 1.7s |  |  |
| 00:24 | Speaker | 😐 | Neutral | 5/10 | 0.0s |  |  |
...
**Total veracity indicators detected: 6**

| Type | Symbol | Count | Avg Certainty | Examples |
|------|--------|-------|---------------|----------|
| contextual_embedding | <context> | 3 | [C:0.55] | Spatial embedding — genuine memory; Contextual embedding — situational recall; Spatial embedding — genuine memory |
| appropriate_recall_pause | <recall-pause> | 3 | [C:0.40] | Natural 0.7s pause before recall — genuine processing; Natural 1.3s pause before recall — genuine processing; Natural 1.7s pause before recall — genuine processing |
...
| 00:00 | contextual_embedding | Contextual embedding — situational recall | <context> | [C:0.55] |
| 00:05 | appropriate_recall_pause | Natural 0.7s pause before recall — genuine processing | <recall-pause> | [C:0.40] |
| 00:11 | contextual_embedding | Spatial embedding — genuine memory | <context> | [C:0.55] |
| 00:11 | appropriate_recall_pause | Natural 1.3s pause before recall — genuine processing | <recall-pause> | [C:0.40] |
| 00:19 | appropriate_recall_pause | Natural 1.7s pause before recall — genuine processing | <recall-pause> | [C:0.40] |
...
| Veracity indicators | 6 (100%) |
| Ratio (veracity:deception) | 6.0:1 |
