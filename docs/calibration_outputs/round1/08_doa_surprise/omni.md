# OMNI OUTPUT — 08_doa_surprise.wav

_Generated: 2026-07-30 16:25:24_
...
| Field | Value |
|-------|-------|
| File | 08_doa_surprise.wav |
| Duration | 00:22 (22.8s) |
| Whisper model | base |
| Language | en |
| Context | general |
...
|--------|------|------|-------------|-------|
| Sit | Person | [C:0.44] | 1 | heuristic ⚠️ verify |
| San | Person | [C:0.44] | 1 | heuristic ⚠️ verify |
| Francisco | Person | [C:0.44] | 1 | heuristic ⚠️ verify |
| this murder | Date (relative) | [C:0.88] | | |
| last night | Date (relative) | [C:0.88] | | |
...
|------|---------|-------|--------|-----------|--------|----------|--------|
| 00:04 | Speaker | 😐 | Neutral | 5/10 | 4.2s |  |  |
| 00:11 | Speaker | 😐 | Neutral | 5/10 | 4.6s | ? |  |
| 00:21 | Speaker | 😐 | Neutral | 5/10 | 4.5s |  |  |
