# OMNI OUTPUT — 11_notld_barbra_breathless.wav

_Generated: 2026-07-30 16:58:58_
...
| Field | Value |
|-------|-------|
| File | 11_notld_barbra_breathless.wav |
| Duration | 00:17 (17.4s) |
| Whisper model | base |
| Language | en |
| Context | general |
...
|------|---------|-------|--------|-----------|--------|----------|--------|
| 00:14 | Speaker | 😐 | Neutral | 5/10 | 14.6s |  |  |
