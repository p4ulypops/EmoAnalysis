# OMNI OUTPUT — 10_reefer_sadness_panic.wav

_Generated: 2026-07-30 16:25:46_
...
| Field | Value |
|-------|-------|
| File | 10_reefer_sadness_panic.wav |
| Duration | 00:07 (7.6s) |
| Whisper model | base |
| Language | en |
| Context | general |
...
|--------|------|------|-------------|-------|
| Thanks | Person | [C:0.44] | 1 | heuristic ⚠️ verify |
...
|------|---------|-------|--------|-----------|--------|----------|--------|
| 00:06 | Speaker | 😐 | Neutral | 5/10 | 6.2s |  |  |
