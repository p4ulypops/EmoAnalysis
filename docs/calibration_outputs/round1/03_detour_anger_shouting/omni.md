# OMNI OUTPUT — 03_detour_anger_shouting.wav

_Generated: 2026-07-30 16:24:32_
...
| Field | Value |
|-------|-------|
| File | 03_detour_anger_shouting.wav |
...
|--------|------|------|-------------|-------|
| Leave | Person | [C:0.53] | 2 | heuristic ⚠️ verify |
| Will | Person | [C:0.44] | 1 | heuristic ⚠️ verify |
...
|------|---------|-------|--------|-----------|--------|----------|--------|
| 00:00 | Speaker | 🫂 | Lonely | 4/10 | 1.0s | ? |  |
| 00:11 | Speaker | 🫂 | Lonely | 4/10 | 0.4s | ? |  |
...
|------|--------|-------|---------------|----------|
| appropriate_recall_pause | <recall-pause> | 1 | [C:0.40] | Natural 1.0s pause before recall — genuine processing |

### Veracity Indicators Detail

| Time | Type | Note | Symbol | [C:] |
|------|------|------|--------|------|
| 00:00 | appropriate_recall_pause | Natural 1.0s pause before recall — genuine processing | <recall-pause> | [C:0.40] |
